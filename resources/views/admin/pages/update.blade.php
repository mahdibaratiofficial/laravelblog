                            ...
                            <div class="col-6">
                                <div class="input-group">
                                    <input class="input--style-4" type="text" name="product" placeholder="Product Name"
                                        value="{{ isset_product($product['product']) }}">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="input-group">
                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-3">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="price" placeholder="Price"
                                        value="{{ isset_product($product['price']) }}">
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="count" placeholder="count"
                                        value="{{ isset_product($product['count']) }}">
                                </div>
                            </div>
                        </div>
